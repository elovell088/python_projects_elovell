...
import functions.temp_conversion
...
if conversion_method == 'f':
    ...
    converted_value = functions.temp_conversion.fahrenheit_to_celcius(fahrenheit)
...
#If statement for conversion of celsius to fahrenheit
    ...
    converted_value = functions.temp_conversion.celsius_to_fahrenheit(celsius)
