#IT 410 - Eric Lovell - Problem 2 - Main 2#

from functions.temp_conversion import fahrenheit_to_celcius
from functions.temp_conversion import celsius_to_fahrenheit
